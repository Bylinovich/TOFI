            ...
            <%--<div class="mbr-table">--%>
                ...
                <%--<div class="mbr-table-cell">--%>
                    ...
                    <%--<ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-sm"--%>
                        ...
                        <%--&lt;%&ndash;<li class="nav-item"><a class="nav-link link" href="${pageContext.request.contextPath}/Merge">MERGE</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
                        ...
                        <%--&lt;%&ndash;<li class="nav-item"><a class="nav-link link" href="${pageContext.request.contextPath}/jsp/about.jsp">ABOUT US</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</li>&ndash;%&gt;--%>

                        <%--&lt;%&ndash;<li class="nav-item dropdown">&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a class="dropdown-toggle nav-link link" style="background: transparent;"&ndash;%&gt;--%>
                               <%--&lt;%&ndash;data-toggle="dropdown" href="#">REPORTS&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<span class="caret"></span></a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<ul class="dropdown-menu" style="min-width: 100%;background: #282828;padding: 10px 10px 10px 20px;border-radius: 5px;">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<li class="nav-link link" style="margin: 0.5rem;"><a href="${pageContext.request.contextPath}/TopUsers">TOP 20 USERS</a></li>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<li class="nav-link link" style="margin: 0.5rem;"><a href="${pageContext.request.contextPath}/jsp/ordersOnDateReport.jsp">ORDERS ON DATE</a></li>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<li class="nav-link link" style="margin: 0.5rem;"><a href="${pageContext.request.contextPath}/YearReport">YEAR REPORT</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
